...
acl purge {
	...
	# pod ip range for gke autopilot cluster
	"10.82.128.0/17";
}
...
sub vcl_recv {
	...
	set req.backend_hint = d.backend("wordpress");
	...
	# Mark static files with the X-Static-File header
...
sub vcl_backend_response {
	...
	if (bereq.http.X-Static-File == "true") {
		...
		set beresp.http.X-Cacheable = "YES:Static file";
		set beresp.ttl = 1d;
	}
